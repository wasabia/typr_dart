...
class Typr_NAME {
  static parse(data, offset, length) {
    ...
    offset += 2;
    var stringOffset = TyprBin.readUshort(data, offset);
    offset += 2;
    ...
    for (var i = 0; i < count; i++) {
      ...
      offset += 2;
      var languageID = TyprBin.readUshort(data, offset);
      offset += 2;
      var nameID = TyprBin.readUshort(data, offset);
      offset += 2;
      var slen = TyprBin.readUshort(data, offset);
      offset += 2;
      var noffset = TyprBin.readUshort(data, offset);
      offset += 2;
      ...
      var tid =
          "p${platformID},${languageID.toRadixString(16)}"; //Typr._platforms[platformID];
