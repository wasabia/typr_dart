...
class Typr_CMAP {
  static Map<String, dynamic> parse(Uint8List buffer, offset, length) {
    ...
    var version = TyprBin.readUshort(data, offset);
    offset += 2;
    ...
    for (var i = 0; i < numTables; i++) {
      var platformID = TyprBin.readUshort(data, offset);
      offset += 2;
      var encodingID = TyprBin.readUshort(data, offset);
      offset += 2;
      var noffset = TyprBin.readUint(data, offset);
      offset += 4;
  ...
  static Map<String, dynamic> parse0(data, offset) {
    ...
    offset += 2;
    var len = TyprBin.readUshort(data, offset);
    offset += 2;
    var lang = TyprBin.readUshort(data, offset);
    offset += 2;
    obj["map"] = [];
  ...
  static Map<String, dynamic> parse4(data, offset) {
    ...
    obj["format"] = TyprBin.readUshort(data, offset);
    offset += 2;
    var length = TyprBin.readUshort(data, offset);
    offset += 2;
    var language = TyprBin.readUshort(data, offset);
    offset += 2;
    var segCountX2 = TyprBin.readUshort(data, offset);
    offset += 2;
  ...
  static Map<String, dynamic> parse6(data, offset) {
    ...
    offset += 2;
    var entryCount = TyprBin.readUshort(data, offset);
    offset += 2;
    obj["glyphIdArray"] = [];
  ...
  static Map<String, dynamic> parse12(data, offset) {
    ...
    offset += 4;
    var lang = TyprBin.readUint(data, offset);
    offset += 4;
    var nGroups = TyprBin.readUint(data, offset);
    offset += 4;
    obj["groups"] = [];
